...
- 🔍 Detects modifications to generated files based on file content markers
- 🎨 Fully customizable comment templates with template variables
- 🏷️ Configurable skip label to bypass checks when intentional
- ⚙️ Flexible file and marker pattern matching
- 💬 Optional PR commenting with automatic updates
